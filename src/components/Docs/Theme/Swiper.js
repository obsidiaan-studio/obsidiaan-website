  ...
  return (
    <div id="swiper" className="docs-item element">
      ...
      <div className="docs-desc">
        <p className="lead">
          Touch-enabled JS plugin that lets you create beautiful responsive
          carousel sliders.
        </p>
        <p>
          Used for the single-item carousels and also for the card carousels.
          You can use Swiper templates included in this template or import and
          customize on your own using docs for this plugin.
        </p>
        <p>
          <a
        ...
        <Collapse in={propsCollapse}>
          <ul>
            <li>
              <b>simple</b> - if true, simple style will be used
            </li>
            <li>
              <b>cards</b> - if true, room cards style will be used
            </li>
            <li>
              <b>propertyCards</b> - if true, property cards style will be used
            </li>
            <li>
              <b>imgCards</b> - if true, image cards style will be used
            </li>
            <li>
              <b>restaurantCards</b> - if true, restaurant cards style will be
              used
            </li>
            <li>
              <b>className</b> - classes for <code>Swiper</code> container
            </li>
            <li>
              <b>slidesPerView</b> - slides per view at smallest size
            </li>
            <li>
              <b>effect</b> - <code>Swiper</code> effect
            </li>
            <li>
              <b>allowTouchMove</b> - if false, touch moves are disabled
              otherways enabled
            </li>
            <li>
              <b>spaceBetween</b> - space between slides
            </li>
            <li>
              <b>centeredSlides</b> - slides centering
            </li>
            <li>
              <b>roundLengths</b> - if true, round values of slides width and
              height to prevent blurry texts on usual resolutions
            </li>
            <li>
              <b>loop</b> - endless loop through slides
            </li>
            <li>
              <b>speed</b> - speed of animation
            </li>
            <li>
              <b>parallax</b> - parallax effect
            </li>
            <li>
              <b>breakpoints</b> - pass breakpoints object for different
              behaviour on different screen sizes
            </li>
            <li>
              <b>xs</b> - slides per view at extra small size
            </li>
            <li>
              <b>sm</b> - slides per view at small size
            </li>
            <li>
              <b>md</b> - slides per view at medium size
            </li>
            <li>
              <b>lg</b> - slides per view at large size
            </li>
            <li>
              <b>xl</b> - slides per view at extra large size
            </li>
            <li>
              <b>xxl</b> - slides per view at at width over 1400px
            </li>
            <li>
              <b>xxxl</b> - slides per view at at width over 1600px
            </li>
            <li>
              <b>autoplay</b> - enables/disables autoplay
            </li>
            <li>
              <b>delay</b> - delay for autoplay
            </li>
            <li>
              <b>pagiantion</b> - if true, pagination bullets will shop up
            </li>
            <li>
              <b>pagiantionClass</b> - class for pagination
            </li>
            <li>
              <b>navigation</b> - if true, navigation arrows will shop up
            </li>
            <li>
              <b>data</b> - pass slides object
            </li>
          </ul>
        </Collapse>
      </div>
      <div className="mt-5">
        ...
        <p className="mb-4 text-muted">
          GeoJSON file used to generate slides:{" "}
          <a href="/content/rooms-geojson.json">rooms-geojson.json</a>
        </p>
        <div className="mb-3">
          <Swiper
      ...
      <div className="mt-5">
        ...
        <p className="mb-4 text-muted">
          GeoJSON file used to generate slides:{" "}
          <a href="/content/restaurants-geojson.json">
            restaurants-geojson.json
          </a>
        </p>
        <div className="mb-3">
          <Swiper
      ...
      <div className="mt-5">
        ...
        <p className="mb-4">
          Parent element must have <code>.position-relative</code> and height
          set
        </p>
